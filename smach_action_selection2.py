...
def main():
    ...
    with sm:
        ...
        with search_sub:
            smach.StateMachine.add('Search',Search_mode(),transitions={'done':'mode_finish' , 'doing':'Search'})
        ...
        smach.StateMachine.add('HARVEST_MODE',harvest_sub, transitions={'mode_finish':'TRANSPORT_MODE'})
        ...
        smach.StateMachine.add('TRANSPORT_MODE',transport_sub, transitions={'mode_finish':'STAND_BY_MODE'})
